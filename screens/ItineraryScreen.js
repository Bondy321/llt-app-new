...
import createItineraryScreenStyles from './styles/ItineraryScreen.styles';
...
export default function ItineraryScreen({ onBack, tourId, tourName, startDate, isDriver, offlineCacheOwnerId }) {
