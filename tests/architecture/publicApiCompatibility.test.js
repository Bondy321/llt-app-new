...
const EXPECTED_FUNCTION_EXPORTS = [
  ...
  'projectDashboardTourActive',
  'projectDashboardTourAssignmentRevision',
  'projectDashboardTourCapacity',
  'projectDashboardTourCode',
  'projectDashboardTourCreated',
  'projectDashboardTourDeleted',
  'projectDashboardTourDriverName',
  'projectDashboardTourEndIndex',
  'projectDashboardTourName',
  'projectDashboardTourPassengerScalar',
  'projectDashboardTourStartDate',
...
const EVENT_PATHS = {
  ...
  projectDashboardDriver: 'drivers/{driverId}',
  projectDashboardManifestAssignment: 'tour_manifests/{tourId}/assigned_drivers/{driverId}',
  projectDashboardManifestAssignmentCode: 'tour_manifests/{tourId}/assigned_driver_codes/{driverId}',
  projectDashboardManifestBooking: 'tour_manifests/{tourId}/bookings/{bookingRef}',
  projectDashboardParticipant: 'tours/{tourId}/participants/{authUid}',
  projectDashboardRecentBroadcast: 'broadcasts/{tourId}/{broadcastId}',
  projectDashboardSafetyAttention: 'tours/{tourId}/safetyAlerts/{eventId}',
  projectDashboardTourActive: 'tours/{tourId}/isActive',
  projectDashboardTourAssignmentRevision: 'tours/{tourId}/driverAssignmentRevision',
  projectDashboardTourCapacity: 'tours/{tourId}/maxParticipants',
  projectDashboardTourCode: 'tours/{tourId}/tourCode',
  projectDashboardTourCreated: 'tours/{tourId}',
  projectDashboardTourDeleted: 'tours/{tourId}',
  projectDashboardTourDriverName: 'tours/{tourId}/driverName',
  projectDashboardTourEndIndex: 'tours/{tourId}/endDateEpochMs',
  projectDashboardTourName: 'tours/{tourId}/name',
  projectDashboardTourPassengerScalar: 'tours/{tourId}/currentParticipants',
  projectDashboardTourStartDate: 'tours/{tourId}/startDate',
...
const SCHEDULES = {
  ...
  processAccountDeletionJobs: 'every 5 minutes',
